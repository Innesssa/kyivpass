 ...
 */
class Application_Model_DbTable_Benefitslist extends Application_Model_DbTable_Abstract
{
    protected $_name = 'benefitslist';
    protected $_primary = 'id'; // primary column name
    protected static $_instance;
    protected static $_fullName = '';
    protected $_fields = array("id","title_short","title_full","title_print","benefit_perc","recoupid","document","description");
