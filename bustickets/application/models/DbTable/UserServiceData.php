 ...
 */
class Application_Model_DbTable_UserServiceData extends Application_Model_DbTable_Abstract
{
    protected $_name = 'userservicedata';
    protected static $_instance;
    protected static $_fullName = '';
    protected $_primary = 'id'; // primary column name
    protected $_fields = array("id","persnum","workstart","workend","defaultstation");
