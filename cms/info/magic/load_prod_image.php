...
{
$upload_path="/image/info/item/tmp/";
...
$uploadfile=$_POST['prodid']."-".$_POST['numer'].".jpg";
if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploaddir.$uploadfile)){
	
GD::imageResize($uploaddir.$uploadfile,$uploaddir.$uploadfile,740,480,100);

//header("Location: /cms/info/magic/crop.php?img=".$upload_path.$uploadfile."&size=740x480");

header("Location: /cms/info/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=740x480");    
...
<?if($_GET['loadimg']!=''){
$bigimg=$_GET['loadimg'];
$medimg=str_replace(".jpg","m.jpg",$bigimg);
$smallimg=str_replace(".jpg","s.jpg",$bigimg);	
